    ...
    <section className="px-4 py-0">
      <div className="container mx-auto max-w-7xl">
        <header className="text-center mb-12">
          <h2 className="text-3xl font-bold text-emerald-900 dark:text-emerald-100 mb-2 md:text-2xl">
            The Six Sacred Kalimas of Islam
          </h2>
          <h3 className="text-emerald-700 dark:text-emerald-300 text-base mb-4">
            Complete Collection: 1st Kalma to 6th Kalma with Arabic Text and Translation
          </h3>
          <p className="text-emerald-700 dark:text-emerald-300 text-base">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {kalimas.map((kalima) => (
            <Card 
              key={kalima.id} 
              className={`cursor-pointer transform hover:scale-105 transition-all duration-300 hover:shadow-2xl border-0 overflow-hidden dark:bg-gray-800 ${
              ...
              <CardContent className="p-0">
                <div className={`bg-gradient-to-br ${kalima.cardColor} text-white p-6 relative`}>
                  <div className="flex items-center justify-between mb-4">
                    <div className={`w-12 h-12 bg-white/20 dark:bg-white/30 rounded-full flex items-center justify-center text-xl font-bold`}>
                      {kalima.id}
                    </div>
                ...
                <div className="p-6 bg-slate-800/90 dark:bg-slate-900/90 text-white">
