...
export const kalimas = [
  {
    ...
    meaning: "This is the declaration of faith (Shahada) that every Muslim must believe and recite to enter Islam.",
    tafsir: "The first Kalima is the bedrock of Islam. Its first part, 'La ilaha illa Allah,' negates all forms of worship, divinity, and authority other than Allah, affirming Him as the sole creator and sustainer. The second part, 'Muhammad ur Rasool Allah,' confirms the acceptance of Prophet Muhammad (peace be upon him) as the final messenger, whose teachings must be followed to live a life pleasing to Allah.",
  ...
  },
  {
    ...
    meaning: "This Kalima adds personal testimony and witness to the declaration of faith, emphasizing the believer's conscious acknowledgment.",
    tafsir: "The second Kalima strengthens the first by adding 'Ashhadu' (I bear witness), making it a personal testimony rather than just a statement. By saying 'abduhu' (His servant), it emphasizes Prophet Muhammad's humanity and servitude to Allah, while 'rasuluh' (His messenger) confirms his divine mission. This Kalima is recited in the five daily prayers and represents the Muslim's conscious commitment to their faith.",
  ...
  },
  {
    ...
    meaning: "This Kalima combines multiple forms of praise and glorification, encompassing the complete spiritual vocabulary of a Muslim's relationship with Allah.",
    tafsir: "The third Kalima contains five fundamental expressions of Islamic worship: Subhan Allah (glorification), Alhamdulillah (praise), La ilaha illa Allah (declaration of monotheism), Allahu Akbar (magnification), and La hawla wa la quwwata illa billah (acknowledgment of divine power). Together, they represent the complete spectrum of a believer's spiritual state - from recognizing Allah's perfection to acknowledging human dependence on divine strength.",
  ...
  },
  {
    ...
    meaning: "This Kalima elaborates on the concept of Tawheed (monotheism), detailing Allah's absolute unity, sovereignty, and eternal nature.",
    tafsir: "The fourth Kalima is a comprehensive statement of Islamic monotheism (Tawheed). It begins with the fundamental declaration and then expands to negate any partnership with Allah ('wahdahu la sharika lahu'). It establishes Allah's complete sovereignty over creation ('lahu al-mulk'), His eternal nature ('la yamutu abadan'), and His absolute power ('qadeer ala kulli shay'). This Kalima is particularly significant as it encompasses the three categories of Tawheed: Tawheed ar-Rububiyyah (Lordship), Tawheed al-Uluhiyyah (Worship), and Tawheed al-Asma wa as-Sifat (Names and Attributes).",
  ...
  },
  {
    ...
    meaning: "This Kalima is a comprehensive prayer for forgiveness, covering all categories of sins and emphasizing genuine repentance (Tawbah).",
    tafsir: "The fifth Kalima represents the pinnacle of Islamic repentance, covering every possible category of sin: intentional and unintentional, public and private, known and unknown. It acknowledges human fallibility while emphasizing Allah's infinite mercy. The phrase 'Allamu al-ghuyub' (Knower of the unseen) recognizes that Allah knows even the sins we ourselves have forgotten. 'Sattaru al-uyub' (Concealer of faults) shows Allah's mercy in not exposing our sins to others. This comprehensive approach to seeking forgiveness reflects the Islamic understanding that true repentance must be thorough and sincere.",
  ...
  },
  {
    ...
    meaning: "This final Kalima serves as a comprehensive rejection of all forms of disbelief and sin while reaffirming complete submission to Islamic monotheism.",
    tafsir: "The sixth Kalima is unique in its comprehensive approach to spiritual purification. It begins with seeking Allah's protection from shirk (associating partners with Allah), the gravest sin in Islam. It then systematically rejects various categories of sins: kufr (disbelief), shirk (polytheism), kadhib (falsehood), ghiba (backbiting), bid'a (innovation in religion), nameema (tale-bearing), fawahish (indecencies), and buhtan (slander). This systematic rejection followed by the reaffirmation of the Shahada creates a complete spiritual renewal, making it particularly significant for those seeking to purify their faith and practice.",
